...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Danh sách tài khoản người dùng</h1>
			</div>
		</div><!--/.row-->

		<div class="row">
			<div class="col-lg-12">
				<button type="button" onclick="javascript:window.location.href='insert_user.php'" class="btn btn-primary" style="margin-bottom: 10px; float: right;">Thêm</button>
			</div>
		</div>
				...
				<table class="table">
					...
					<tbody>
						...
						<?php
							...
							$i			=	1;
							$sql		=	"select * from user limit $pos, $pageSize";
							$mq			=	mysqli_query($connect,$sql);
							...
							while($row=mysqli_fetch_array($mq)){
								echo "
									<tr>
										...
										<td><a href='del_user.php?id=".$row['id_user']."'>Xóa</a></td>
									</tr>
								";
								$i++;
							}
							...
							<th colspan="7">
								<?php									
									...
									for($i=1; $i<=ceil($count/$pageSize);$i++){
										echo "<a href='list_user.php?page=$i'";
										underline($page,$i);
										echo ">".$i."</a>&nbsp;&nbsp";
									}
								?>
