...
<head>
	...
	<title>Order | MONASHOP.com</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active"><a href="list_order.php"><em class="fa fa-shopping-cart">&nbsp;</em> Đơn hàng</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<button type="button" onclick="javascript:window.location.href='insert_order.php'" class="btn btn-primary" style="margin-bottom: 10px; float: right;">Thêm</button>
			</div>
				...
				<table class="table">
					...
					<tbody>
						...
						<?php
							...
							$i			=	1;
							$sql		=	"select * from order limit $pos, $pageSize";
							...
							while($row=mysqli_fetch_assoc($mq)){
								echo "
									<tr>
										...
										<td>".format_money($row['payments'])."</td>								
										<td><a href='../admin/list_order.php?id=".$row['id_order']."'>Sửa</a></td>
										<td><a href='../admin/del_order.php?id=".$row['id_order']."'>Xóa</a></td>
									</tr>
								";
								$i++;
							}
							...
							<th colspan="6">
								<?php									
									...
									for($i=1; $i<=ceil($count/$pageSize);$i++){
										echo "<a href='list_order.php?page=$i'";
										underline($page,$i);
										echo ">".$i."</a>&nbsp;&nbsp";
									}
								?>
